          ...
          {ROLE_CATEGORIES.map((r) => {
            ...
            return (
              <button
                ...
                aria-pressed={active}
                className={`flex cursor-pointer items-center gap-2.5 border-[1.5px] bg-card px-3 py-2.5 font-mono text-xs uppercase tracking-[0.08em] text-ink transition-colors ${
          ...
          {PREFERRED_COLORS.map((c) => {
            ...
            return (
              <button
                ...
                className={`flex cursor-pointer items-center gap-2.5 border-[1.5px] bg-card py-2 pl-2 pr-3.5 font-mono text-xs uppercase tracking-[0.08em] text-ink transition-colors ${
